...
class Day(models.Model):
    ...
    def load(cls, **kwargs):
        ...
        pass
    def clean(self):
        if self.name.capitalize() not in ("Monday", "Tuesday", "Wednesday", "Thursday", "Friday"):
            raise ValidationError("Invalid day name, should assume Monday...Friday")
...
class Class(models.Model):
    ...
    day = models.ForeignKey(Day, related_name='classes', on_delete=models.CASCADE)
    time = models.CharField(max_length=10)
    venue = models.CharField(blank=True, max_length=64)

    def __str__(self):
        return "Course: {} Day: {} Time: {} Venue: {}".format(self.course, self.day, self.time, self.venue)
